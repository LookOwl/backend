...
from old.infrastructure.database.models.solicitud_libro import SolicitudLibro as SolicitudLibroModel
from old.domain.solicitud_libro import BookRequest
from old.domain.enums.estado_solicitud import EstadoSolicitud
