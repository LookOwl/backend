...
from old.api.dtos.login_dto import RegisterUserDto
...
from old.domain.exceptions import UsuarioNoEncontrado
from old.domain.user import User, UserCredentials
from old.services.auth_service import AuthService, UnknownException
