...
from old.core.security import ALGORITHM, SECRET_KEY, generate_token, hash_password, verify_password
from old.core.auth_guard import user_auth_guard
from old.api.controllers.books import router as books_router
from old.api.controllers.users import router as users_router
from old.dependencies.services import get_auth_service, get_book_service
from old.domain.book import Book
from old.domain.enums.roles_usuario import RolUsuario
from old.domain.user import User, UserCredentials
from old.services.auth_service import UserAlreadyExistsException
...
class FakeAuthService:
    ...
    async def validateToken(self, token: str):
        from old.core.security import decode_token
