...
from old.domain.solicitud_libro import BookRequest, EstadoSolicitud
from old.domain.book_copy import BookCopy, EstadoEjemplar
from old.domain.loan import Loan, EstadoPrestamo
