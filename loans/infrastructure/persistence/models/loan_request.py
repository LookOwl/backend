...
if TYPE_CHECKING:
    ...
    from users.infrastructure.persistence.models.user import UsuarioSolicitudNotificationes
...
class SolicitudLibro(BaseModel):
    ...
    id_ejemplar: Mapped[Optional[int]] = mapped_column(ForeignKey("ejemplares.id"))
    ...
    notificaciones : Mapped[List["UsuarioSolicitudNotificationes"]] = relationship(back_populates="solicitud")